...
public class JavaMultithreading {
    ...
    public static void main(String[] args) {
        JFrame window = new JFrame("Lab3 OOP (Demydenko)");
        ...
        JButton btn1 = new JButton("Block 1");
        btn1.setBounds(30, 400, 100, 50);
        btn1.setBackground(Color.GREEN);
        pan.add(btn1);

        JButton btn2 = new JButton("Block 2");
        btn2.setBounds(130, 400, 100, 50);
        btn2.setBackground(Color.BLUE);
        pan.add(btn2);

        JButton btn3 = new JButton("Block 3");
        btn3.setBounds(230, 400, 100, 50);
        btn3.setBackground(Color.RED);
        pan.add(btn3);

        JButton btn4 = new JButton("All Blocks");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Thread thread = new Thread() {
                    ...
                    public void run() {
                        ...
                        while (sqr1.getLocation().x != sqr2.getLocation().x - 50) {
                        }
